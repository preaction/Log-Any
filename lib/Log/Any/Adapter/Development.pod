...
The adapter module:
   ...
   package Log::Any::Adapter::Log::YAL;
   use strict;
   use warnings;
...
L<Log::Any::Adapter::Log::Log4perl|Log::Any::Adapter::Log::Log4perl> and
L<Log::Any::Adapter::Log::Dispatch>.
...
At this point, overriding the default constructor is not supported. Hopefully it
will not be needed.
...
Then C<$log> will be populated with the return value of:
    ...
    Log::Any::Adapter::Log::Yal->new(yal_object => $yal, depth => 3, category => 'Foo');

This is memoized, so if the same category should be requested again
(e.g. through a separate C<get_logger> call, the same object will be
returned. Therefore, you should try to avoid anything non-deterministic
in your L</init> function.
...
See L<Log::Any::Adapter::Log::Dispatch|Log::Any::Adapter::Log::Dispatch> and
L<Log::Any::Adapter::Log::Log4perl|Log::Any::Adapter::Log::Log4perl> for
examples of usage.
